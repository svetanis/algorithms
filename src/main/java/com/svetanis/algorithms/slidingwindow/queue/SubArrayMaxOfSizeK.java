...
public final class SubArrayMaxOfSizeK {
  ...
  private static ImmutableList<Integer> subArrayMax(int[] a, int k) {
    // Time complexity: O(n);
    // Auxiliary Space: O(k)
  ...
  public static void main(String[] args) {
    ...
    System.out.println(subArrayMax(a1, 3));

    int[] a2 = { 8, 5, 10, 7, 9, 4, 15, 12, 90, 13 };
    System.out.println(subArrayMax(a2, 4));
  }
}