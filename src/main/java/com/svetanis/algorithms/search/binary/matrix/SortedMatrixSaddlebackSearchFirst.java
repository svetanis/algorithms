...
// Design an efficient algorithm to search 
// for a given integer x in a 2D sorted array a[0..m][0..n].
// It is sorted row-wise and column-wise in ascending order. 
// In case of multiple occurrences, 
// please find the very first occurrence,
// i.e., the occurrence with the smallest value of the row index and 
// at the same time the occurrence with 
// the smallest value of the column index as well.
