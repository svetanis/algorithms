...
public final class GeneralizeAbbreviationsRecursive {
	...
	public static ImmutableList<String> generate(String s) {
		...
		generate(s, new StringBuilder(), 0, 0, list);
		return newList(list);
	}

	private static void generate(String s, StringBuilder sb, int start, int count, List<String> list) {
		...
		generate(s, sbc, start + 1, count + 1, list);
