...
public final class KnapsackWeightOnlyBruteForce {
	...
	private static void dfs(int index, int sum, List<Integer> weights, 
			Set<Integer> set) {
		...
		// include
		dfs(index + 1, sum + weights.get(index), weights, set);
	}
