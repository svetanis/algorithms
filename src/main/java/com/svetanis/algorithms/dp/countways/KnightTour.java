...
// The constraint is that the movement from one digit to the next is similar to the movement of 
...
public final class KnightTour {
  ...
  public static void main(String[] args) {
    System.out.println(recursive(1, 2) + ": " + dynamic(1, 2));// 2
    System.out.println(recursive(1, 3) + ": " + dynamic(1, 3));// 5
    System.out.println(recursive(9, 13) + ": " + dynamic(9, 13));// 19520
    System.out.println(recursive(2, 4) + ": " + dynamic(2, 4));// 10
    System.out.println(recursive(2, 8) + ": " + dynamic(2, 8));// 272
    System.out.println(recursive(2, 12) + ": " + dynamic(2, 12));// 7456
    System.out.println(recursive(2, 16) + ": " + dynamic(2, 16));// 204416
  }
}
